...
- **2 Applications**
  ...
  - `web` - React e-commerce application with product listings and detail views
  - `api` - Backend API serving product data

- **7 Libraries**

  - `@org/web-feature-products` - Product listing feature (React)
  - `@org/web-feature-product-detail` - Product detail feature (React)
  - `@org/web-data` - Data access layer for web features
  - `@org/web-shared-ui` - Shared UI components
  - `@org/models` - Shared data models
  - `@org/api-products` - API product service library
  - `@org/shared-test-utils` - Shared testing utilities

- **E2E Testing**
  - `web-e2e` - Playwright tests for the web application
...
- `scope:web` - web-specific libraries
...
```
├── apps/
│   ├── web/           [scope:web]    - React e-commerce app
│   ├── web-e2e/                       - E2E tests for web
│   └── api/            [scope:api]     - Backend API
├── libs/
│   ├── web/
│   │   ├── feature-products/        [scope:web,type:feature] - Product listing
│   │   ├── feature-product-detail/  [scope:web,type:feature] - Product details
│   │   ├── data/                    [scope:web,type:data]    - Data access
│   │   └── shared-ui/               [scope:web,type:ui]      - UI components
│   ├── api/
...
| ----------------------- | ---------------------------- | ---------------------------- |
| `web`                  | `scope:web`                 | `scope:web`, `scope:shared` |
| `api`                   | `scope:api`                  | `scope:api`, `scope:shared`  |
| `web-feature-products` | `scope:web`, `type:feature` | `scope:web`, `scope:shared` |
| `web-data`             | `scope:web`, `type:data`    | `scope:shared`               |
...
# Development
npx nx serve web                              # Serve React app
npx nx serve api                               # Serve backend API
npx nx build web                              # Build React app
npx nx test web-data                          # Test a specific library
npx nx lint web-feature-products              # Lint a specific library
